...
namespace ThePage.Droid
{
    ...
    public class AddBookFragment : BaseFragment<AddBookViewModel>, ViewTreeObserver.IOnGlobalFocusChangeListener
    {
        #region Properties

        protected override int FragmentLayoutId => Resource.Layout.fragment_addbook;
