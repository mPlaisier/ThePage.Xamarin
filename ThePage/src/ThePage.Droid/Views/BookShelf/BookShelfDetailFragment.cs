...
namespace ThePage.Droid
{
    ...
    public class BookShelfDetailFragment : BaseFragment<BookShelfDetailViewModel>, ViewTreeObserver.IOnGlobalFocusChangeListener
    {
        #region Properties

        protected override int FragmentLayoutId => Resource.Layout.fragment_bookshelfdetail;
